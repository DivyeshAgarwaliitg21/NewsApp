...
import com.adiv.newsapp.bookmark.BookMarkViewModel_HiltModules_KeyModule_ProvideFactory;
...
import com.adiv.newsapp.di.AppModule_ProvideAppEntryUseCasesFactory;
import com.adiv.newsapp.di.AppModule_ProvideLocalUserManagerFactory;
import com.adiv.newsapp.di.AppModule_ProvideNewsDaoFactory;
import com.adiv.newsapp.di.AppModule_ProvideNewsRepositoryFactory;
import com.adiv.newsapp.di.AppModule_ProvideNewsUseCasesFactory;
import com.adiv.newsapp.di.AppModule_ProvidesNewsApiFactory;
import com.adiv.newsapp.di.AppModule_ProvidesNewsDatabaseFactory;
...
import com.biprangshu.newsapp.details.DetailsViewModel_HiltModules_KeyModule_ProvideFactory;
...
public final class DaggerNewsApplication_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends NewsApplication_HiltComponents.ActivityC {
    ...
    private MainActivity injectMainActivity2(MainActivity instance) {
      MainActivity_MembersInjector.injectAppEntryUseCases(instance, singletonCImpl.provideAppEntryUseCasesProvider.get());
      return instance;
    }
  }
  ...
  private static final class ViewModelCImpl extends NewsApplication_HiltComponents.ViewModelC {
    ...
    public Map<String, Provider<ViewModel>> getHiltViewModelMap() {
      return MapBuilder.<String, Provider<ViewModel>>newMapBuilder(6).put("com.adiv.newsapp.bookmark.BookMarkViewModel", ((Provider) bookMarkViewModelProvider)).put("com.biprangshu.newsapp.details.DetailsViewModel", ((Provider) detailsViewModelProvider)).put("com.adiv.newsapp.HomeViewModel", ((Provider) homeViewModelProvider)).put("com.adiv.newsapp.MainViewModel", ((Provider) mainViewModelProvider)).put("com.adiv.newsapp.OnBoardingViewModel", ((Provider) onBoardingViewModelProvider)).put("com.adiv.newsapp.SearchViewModel", ((Provider) searchViewModelProvider)).build();
    }
  ...
  private static final class SingletonCImpl extends NewsApplication_HiltComponents.SingletonC {
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      this.provideLocalUserManagerProvider = DoubleCheck.provider(new SwitchingProvider<LocalUserManager>(singletonCImpl, 1));
      this.provideAppEntryUseCasesProvider = DoubleCheck.provider(new SwitchingProvider<AppEntryUseCases>(singletonCImpl, 0));
      this.providesNewsApiProvider = DoubleCheck.provider(new SwitchingProvider<NewsApi>(singletonCImpl, 4));
      this.providesNewsDatabaseProvider = DoubleCheck.provider(new SwitchingProvider<NewsDataBase>(singletonCImpl, 6));
      this.provideNewsDaoProvider = DoubleCheck.provider(new SwitchingProvider<NewsDao>(singletonCImpl, 5));
      this.provideNewsRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<NewsRepository>(singletonCImpl, 3));
      this.provideNewsUseCasesProvider = DoubleCheck.provider(new SwitchingProvider<NewsUseCases>(singletonCImpl, 2));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.adiv.newsapp.domain.usecases.AppEntryUseCases 
          ...
          case 1: // com.adiv.newsapp.domain.LocalUserManager 
          ...
          case 2: // com.adiv.newsapp.domain.usecases.NewsUseCases 
          ...
          case 3: // com.adiv.newsapp.domain.repository.NewsRepository 
          return (T) AppModule_ProvideNewsRepositoryFactory.provideNewsRepository(singletonCImpl.providesNewsApiProvider.get(), singletonCImpl.provideNewsDaoProvider.get());

          case 4: // com.adiv.newsapp.data.remote.NewsApi 
          return (T) AppModule_ProvidesNewsApiFactory.providesNewsApi();

          case 5: // com.adiv.newsapp.data.local.NewsDao 
          return (T) AppModule_ProvideNewsDaoFactory.provideNewsDao(singletonCImpl.providesNewsDatabaseProvider.get());

          case 6: // com.adiv.newsapp.data.local.NewsDataBase 
